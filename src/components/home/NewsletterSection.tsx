...
const NewsletterSection = () => {
  ...
  return (
    <section className="py-16 bg-keralaGreen text-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">Join Our Culinary Journey</h2>
          <p className="text-lg mb-8 opacity-90">
            Subscribe to our newsletter for authentic Kerala recipes, restaurant updates, and exclusive offers on traditional spices.
          </p>
